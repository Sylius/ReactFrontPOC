...
import VerificationPage from "../pages/account/VerificationPage.tsx"; // Importujemy nową stronę
...
export const coreRoutes: RouteObject[] = [
  ...
  { path: "verify", element: <VerificationPage /> }, // Dodana nowa trasa do weryfikacji
];
