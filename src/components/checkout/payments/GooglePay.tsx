...
const GooglePay: FC<GooglePayProps> = ({ submitFunction }) => {
  ...
  return (
    <div className='card bg-body-tertiary border-0 mb-3' onClick={pay}>
      <label className='card-body cursor-pointer' htmlFor='google-pay-input'>
        <input
          type='radio'
          id='google-pay-input'
          name='payment-method'
        ...
        <div className='d-flex align-items-center'>
          ...
          <div>
            <div>
              <div>
                <div className='form-check-label required'>Google Pay</div>
              </div>
            </div>
