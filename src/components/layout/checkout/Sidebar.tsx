        ...
        <table className='table mb-3'>
          <tbody>
            {order?.items?.map((orderItem: OrderItem) => (
              <tr key={orderItem.id}>
                <td>
                  <div className='py-3 h6 mb-0 text-break'>{orderItem.productName}</div>
                </td>
                <td>
                  <div className='py-3 text-end text-body-tertiary'>{orderItem.quantity}</div>
                </td>
                <td>
                  <div className='py-3 text-end'>${formatPrice(orderItem.subtotal)}</div>
                </td>
              </tr>
            ))}
          </tbody>
