      ...
      <div className='container'>
        <div className='row align-items-center'>
          <div className='col'>
            <Link
              to='/'
              className='d-inline-block py-lg-2'
              style={{ width: '10rem' }}
          ...
          >
            <Link to='/cart'>
              <div>
                <button
                  type='button'
                  className='btn btn-icon btn-transparent px-0 position-relative'
          ...
          <div className='col-auto d-lg-none'>
            <button
              className='navbar-toggler btn btn-icon btn-transparent px-0'
              type='button'
              data-bs-toggle='offcanvas'
