    ...
    <div className='mt-auto border-top mt-5 py-5'>
      <footer className='container'>
        <div className='row'>
          ...
          <div className='col-12 text-center col-md-6 order-md-4 text-md-start col-lg-3 order-lg-4 text-lg-center'>
            <div className='mb-3 fw-medium'>Payment methods:</div>

            <div className='row g-2 mb-4'>
              <div className='col-4'>
                <a
                  href='https://sylius.com/partner/paypal/'
                  target='blank'
              ...
              <div className='col-4'>
                <a
                  href='https://sylius.com/partner/adyen/'
                  target='blank'
                  className='d-block border rounded p-2'
                >
                  <img
              ...
              <div className='col-4'>
                <a
                  href='https://sylius.com/partner/mollie/'
                  target='blank'
                  className='d-block border rounded p-2'
                >
                  <img
            ...
            <div className='d-flex justify-content-center justify-content-md-start justify-content-lg-center gap-3 mb-5'>
              <a
                className='link-reset'
                href='https://www.instagram.com/sylius.team/'
                target='blank'
              ...
              <a
                className='link-reset'
                href='https://www.facebook.com/SyliusEcommerce/'
                target='blank'
            ...
            <a href='/en_US/' className='d-inline-block mb-4' aria-label='sylius logo'>
              <div style={{ width: '10rem' }}>
                ...
                >
                  ...
                  />
                  <path
                    d='M143.417 605.333l206.625 413.25 381.375.625 92.291-129.916-680.291-283.959z'
                    fill='#30ba9d'
                    fillRule='nonzero'
                  />
                  <path
