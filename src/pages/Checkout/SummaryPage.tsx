        ...
        <CheckoutLayout sidebarOn={false}>
            <div className="col pt-4 pb-5">
                <div className="mx-auto">
                    ...
                    <form name="sylius_checkout_complete" onSubmit={handleSubmit}
                          noValidate={true}>
                        ...
                        <div className="row">
                            <div className="col-12 col-md-6 mb-3">
                                { order?.billingAddress && <Address sectionName='Billing addresss' address={order.billingAddress} /> }
                            </div>

                            <div className="col-12 col-md-6 mb-3">
                                { order.shippingAddress && <Address sectionName={'Shipping address'} address={order.shippingAddress} /> }
                            </div>
                        </div>

                        <div className="mb-5">
                            { order?.payments && <PaymentsCard payment={order?.payments[0]} total={order?.total} /> }
                        ...
                        <div className="table-responsive border-bottom mb-4">
                            <table className="table table-borderless table-space align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <th className="border-bottom mb-4 pb-4 " data-test-table="item">
                                        Item
                                    </th>


                                    <th className="border-bottom mb-4 pb-4 text-end" data-test-table="price">
                                        Unit price
                                    </th>


                                    <th className="border-bottom mb-4 pb-4 text-end" data-test-table="qty">
                                        Qty
                                    </th>


                                    <th className="border-bottom mb-4 pb-4 text-end" data-test-table="subtotal">
                                        Subtotal
                                    </th>
                                </tr>
                                </thead>
                        ...
                        <div className="text-center">
                            <button type="submit" className="btn btn-primary" id="confirmation-button" disabled={isSubmitting}>
                                Place order
                            </button>
                        </div>
                    </form>
