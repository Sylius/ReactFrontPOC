            ...
            <div className='card border-0 bg-body-tertiary mb-3'>
              <div className='card-body d-flex flex-column gap-1'>
                ...
                <div className='row'>
                  ...
                  <div className='col d-flex gap-2 align-items-center'>{order.localeCode}</div>
                </div>
              </div>
            </div>
          )}

          <form name='sylius_checkout_complete' onSubmit={handleSubmit} noValidate={true}>
            <input type='hidden' name='_method' value='PUT' />

            <div className='row'>
              <div className='col-12 col-md-6 mb-3'>
                {order?.billingAddress && (
                  <Address sectionName='Billing addresss' address={order.billingAddress} />
                )}
              </div>
            ...
            <table className='table table-borderless align-middle ms-auto mb-6'>
              <tbody>
                ...
                <tr>
                  <td className='w-75'>
                    <div className='h5 text-end border-top pt-4 mt-3'>Total:</div>
                  </td>
