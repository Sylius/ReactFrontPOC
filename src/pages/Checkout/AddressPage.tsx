            ...
            <div className="col-12 col-lg-7 pt-4 pb-5">
                <div className="pe-lg-6">
                    ...
                    <div data-controller="live" data-live-name-value="sylius_shop:checkout:address:form"
                        ...
                        <form name="sylius_shop_checkout_address" method="post" action="/en_US/checkout/address"
                              data-model="on(change)|*" noValidate={ true } onSubmit={handleSubmit}>
                            ...
                            <div data-controller="api-login" data-api-login-url-value="/en_US/json-login-check">
                                <div className="d-none">
                                    <div className="alert alert-danger" data-api-login-target="errorPrototype"></div>
                                </div>
                                <div className=" field mb-3 required"><label
                                    htmlFor="sylius_shop_checkout_address_customer_email"
                                    className="form-label required">Email</label>
                                    <input
                                        type="email"
                            ...
                            <div className="mb-4 ">
                                    ...
                                    <div className="row">
                                        <div className="col-12 col-md-6">
                                            <div className=" field mb-3 required">
                                                ...
                                                <input
                                                    ...
                                                    required={true}
                                                    className="form-control"
                                                    value={billingAddress.firstName} onChange={handleChange}
                                                />
                                        ...
                                        <div className=" field mb-3 required"><label
                                                ...
                                                className="form-label required">Last name</label>
                                                <input
                                                    type="text"
                                                    ...
                                                    required={ true }
                                                    className="form-control"
                                                    value={billingAddress.lastName} onChange={handleChange}
                                                />
                                    ...
                                    <div className=" field mb-3"><label
                                        ...
                                        <input
                                            ...
                                            name="company"
                                            className="form-control"
                                            value={billingAddress.company} onChange={handleChange}
                                        />
                                    ...
                                    <div className=" field mb-3 required"><label
                                        ...
                                        className="form-label required">Street address</label>
                                        <input
                                            ...
                                            required={ true }
                                            className="form-control"
                                            value={billingAddress.street} onChange={handleChange}
                                        />
                                    ...
                                    <div className="mb-3">
                                        <div className=" field mb-3 required"><label className="form-label required"
                                                                                     htmlFor="sylius_shop_checkout_address_billingAddress_countryCode">Country</label><select
                                            id="sylius_shop_checkout_address_billingAddress_countryCode"
                                            name="countryCode"
                                            required={ true } className="form-select" value={billingAddress.countryCode} onChange={handleChange}>
                                    ...
                                    <div className=" field mb-3 required"><label
                                        ...
                                        className="form-label required">City</label>
                                        <input
                                            type="text"
                                            ...
                                            required={ true }
                                            className="form-control"
                                            value={billingAddress.city} onChange={handleChange}
                                        />
                                    ...
                                    <div className=" field mb-3 required"><label
                                        ...
                                        className="form-label required">Postcode</label>
                                        <input
                                            ...
                                            required={ true }
                                            className="form-control"
                                            value={billingAddress.postcode} onChange={handleChange}
                                        />
                                    ...
                                    <div className=" field mb-3"><label
                                        ...
                                        <input
                                            ...
                                            name="phoneNumber"
                                            className="form-control"
                                            value={billingAddress.phoneNumber} onChange={handleChange}
                                        />
                            ...
                            <input type="hidden" id="sylius_shop_checkout_address__token"
                                   name="sylius_shop_checkout_address[_token]" data-controller="csrf-protection"
