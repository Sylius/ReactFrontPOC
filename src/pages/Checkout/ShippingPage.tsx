...
const ShippingPage: React.FC = () => {
    ...
    const { data: shippingMethods } = useQuery({ queryKey: ["shipping-methods"], queryFn: fetchShippingMethodsFromAPI, enabled: order !== null });
                                                ...
                                                <div>
                                                    <div className="form-check">
                                                        ...
                                                        <label className="form-check-label required"
                                                               htmlFor="sylius_shop_checkout_select_shipping_shipments_0_method_0">{method.name}</label>
                                                    </div>
                                                </div>
