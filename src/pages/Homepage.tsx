      ...
      <div className='mb-5'>
        <div className='overflow-hidden'>
          <div className='d-flex justify-content-center align-items-center position-relative'>
            <img
              src={`${import.meta.env.VITE_API_URL}/build/shop/images/homepage-banner.8ec389de.webp`}
              width='1920'
              height='793'
              className='img-fluid'
              alt='Home'
            />
            <img
              src={`${import.meta.env.VITE_API_URL}/build/shop/images/homepage-banner-logo.6759d0fb.webp`}
      ...
      <div className='container mb-5'>
        ...
        <div className='photo-grid'>
          <div className='photo-grid-item-1'>
            <img
              src={`${import.meta.env.VITE_API_URL}/build/shop/images/homepage-new-collection-photo-1.2b163989.webp`}
          ...
          <div className='photo-grid-item-2'>
            <img
              src={`${import.meta.env.VITE_API_URL}/build/shop/images/homepage-new-collection-photo-2.2c91a0c3.webp`}
              className='object-fit-cover w-100 h-100 rounded-3'
              loading='lazy'
              alt='New collection'
            />
          ...
          <div className='photo-grid-item-3'>
            <img
              src={`${import.meta.env.VITE_API_URL}/build/shop/images/homepage-new-collection-photo-3.466a0c4c.webp`}
              className='object-fit-cover w-100 h-100 rounded-3'
              loading='lazy'
              alt='New collection'
            />
